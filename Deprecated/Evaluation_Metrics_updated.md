...
For AAIE, we’re fine-tuning language models to  detect AI-generated writing and produce teacher-style feedback for student work. This report explains the metrics we’ll use to judge whether our models are doing a good job—what each metric tells us, what it doesn’t, and when to use which.
